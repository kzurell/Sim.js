...
Sim.App.prototype.objectFromMouse = function(pagex, pagey)
{
    ...
    var rayobj = (this.objects[0]).object3D;

    var intersects = ray.intersectObjects( [rayobj], true /* recursive */ );
    ...
    if ( intersects.length > 0 ) {
        ...
        var or = intersected.point;
        var point = or.applyMatrix4(mat);
...
//setVisible - change visibility on object and children.
